...
public class paymentController {
	...
	public String listCashier(Model model) {
		...
		model.addAttribute("allCashier", allCashier);
		return "hospital_sys/cashier_list"; // form to create user
	}

	
	 @ResponseBody 
	 @RequestMapping(value = "/payment/createpost", method = RequestMethod.POST)
	 @Transactional 
	 ...
	 @RequestMapping(value = "/payment/detail/{id}", method = RequestMethod.GET) 
