...
<!--                         </li> -->
                        <li> <a class="waves-effect waves-dark" href="table-basic.html" aria-expanded="false"><i 
                                    class="fa fa-hospital-o"></i><span class="hide-menu" style="color:#20aee3 !important">Department Management</span></a>
	                      </li>
...
<!--                         </li> -->
                        <li> <a class="waves-effect waves-dark"  href="${contextPath}/hospital/homeAdmin" aria-expanded="false"><i
                                    class="fa fa-user"></i><span class="hide-menu" >User Management</span></a>
                        </li>
                    </ul>
