            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            <img width="126" height="19" src="${pageContext.request.contextPath}/images/landingpage/logo.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="${pageContext.request.contextPath}/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="${pageContext.request.contextPath}/assets/images/users/1.jpg" alt="user" class="" /> <span
...
<!--                         </li> -->
                        <li> <a class="waves-effect waves-dark"  href="${contextPath}/hospital/home" aria-expanded="false"><i
                                    class="fa fa-user-circle-o"></i><span class="hide-menu" style="color:#20aee3 !important">Users Management</span></a>
                        </li>
                    </ul>
...
<%--   onClick="doGet('${pageContext.request.contextPath}/user/detail?id=${user.id}')" --%>
										           ...
										           onClick="doGet('${pageContext.request.contextPath}/user/detail?id=${user.id}','page-content-element')"
						                               ...
						                               <option value="update" 
						                                   ...
						                                   onClick="doGet('${pageContext.request.contextPath}/user/update?id=${user.id}','page-content-element')">Edit</option>
													
													   <option value="delete"
													
													      onClick="doGet('${pageContext.request.contextPath}/user/delete?id=${user.id}')">Delete</option>	
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer"> © 2021 PresClinic by <a href="https://www.wrappixel.com/">Presprint PLC</a> </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
