...
<!-- 		<div class="spinner"> -->
<!-- 		 <span class="spinner-rotate">gfdhf</span> -->
<!--           </div>  -->
<!-- 	 </section>  -->
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand">Presclinic</a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="index.html#about" class="smoothScroll">Hospital Creation</a></li>
                         <li><a href="index.html#blog" class="smoothScroll">Human Resource</a></li>
                         <li><a href="index.html#work" class="smoothScroll">Cash-in</a></li>
                         <li><a href="index.html#contact" class="smoothScroll">Users</a></li>
                    </ul>
