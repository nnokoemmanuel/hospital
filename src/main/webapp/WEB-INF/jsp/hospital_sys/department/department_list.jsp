...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
                ...
                <div class="row page-titles" id="page-content-title">
                    ...
                    <div class="col-md-7 align-self-center">
                        <a 
                            class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down" onclick="doGet('${pageContext.request.contextPath}/department/create', 'page-content-element');">CREATE A DEPARTMENT</a>
                    </div>
                </div>
                <!-- ============================================================== -->
                                           ...
                                           <c:forEach var="department"  items="${department}">
                                            <tr>
                                                ...
                                                <td>${department.departmentDescription}</td>
						                         ...
						                         <td>
						                          <select onchange="list_action(this.value,'${department.id}');"> 
